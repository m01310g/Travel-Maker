...
class GyeongbukInfo extends StatefulWidget {
  const GyeongbukInfo({Key? key}) : super(key: key);

  @override
  _GyeongbukInfoState createState() => _GyeongbukInfoState();
}

class _GyeongbukInfoState extends State<GyeongbukInfo> {
