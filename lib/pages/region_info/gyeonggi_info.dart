...
class _GyeonggiInfoState extends State<GyeonggiInfo> {
  ...
  Future<void> fetchRegionInfo() async {
    ...
    final url =
        'http://apis.data.go.kr/B551011/KorService1/areaBasedList1?ServiceKey=$apiKey&areaCode=31&arrange=D&numOfRows=20&pageNo=1&MobileOS=ETC&MobileApp=AppTest&_type=json';
