...
class GyeonggiInfo extends StatefulWidget {
  const GyeonggiInfo({Key? key});

  @override
  _GyeonggiInfoState createState() => _GyeonggiInfoState();
}

class _GyeonggiInfoState extends State<GyeonggiInfo> {
  ...
  Future<void> fetchRegionInfo(String contentTypeId, String subCategory) async {
    ...
    String url =
        'http://apis.data.go.kr/B551011/KorService1/areaBasedList1?ServiceKey=$apiKey&areaCode=31&contentTypeId=$contentTypeId&arrange=D&numOfRows=200&pageNo=1&MobileOS=ETC&MobileApp=AppTest&_type=json';
