...
class _SeoulInfoState extends State<SeoulInfo> {
  ...
  Future<void> fetchRegionInfo(String contentTypeId, String subCategory) async {
    ...
    String url =
        'http://apis.data.go.kr/B551011/KorService1/areaBasedList1?ServiceKey=$apiKey&areaCode=1&contentTypeId=$contentTypeId&arrange=D&numOfRows=50&pageNo=1&MobileOS=ETC&MobileApp=AppTest&_type=json';
