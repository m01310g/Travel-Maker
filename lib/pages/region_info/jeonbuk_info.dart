...
class JeonbukInfo extends StatefulWidget {
  const JeonbukInfo({Key? key});

  @override
  _JeonbukInfoState createState() => _JeonbukInfoState();
}

class _JeonbukInfoState extends State<JeonbukInfo> {
  ...
  Future<void> fetchRegionInfo(String contentTypeId, String subCategory) async {
    ...
    String url =
        'http://apis.data.go.kr/B551011/KorService1/areaBasedList1?ServiceKey=$apiKey&areaCode=37&contentTypeId=$contentTypeId&arrange=D&numOfRows=200&pageNo=1&MobileOS=ETC&MobileApp=AppTest&_type=json';
