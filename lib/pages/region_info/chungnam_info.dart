...
class _ChungnamInfoState extends State<ChungnamInfo> {
  ...
  Future<void> fetchRegionInfo() async {
    final apiKey =
        '***REMOVED***';
    final url =
        'http://apis.data.go.kr/B551011/KorService1/areaBasedList1?ServiceKey=$apiKey&areaCode=3&arrange=D&numOfRows=20&pageNo=1&MobileOS=ETC&MobileApp=AppTest&_type=json';
