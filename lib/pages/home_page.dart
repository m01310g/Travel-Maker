...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> fetchFestivalData() async {
    ...
    const url = 'http://apis.data.go.kr/B551011/KorService1/areaBasedList1?ServiceKey=$apiKey&arrange=D&contentTypeId=15&numOfRows=100&pageNo=1&MobileOS=ETC&MobileApp=AppTest&_type=json';
        ...
        slivers: <Widget>[
          SliverAppBar(
            ...
            title: Row(
              children: [
                Image.asset(
                  'assets/images/travel_maker_logo_h.png',
                  height: 45,
                ),
                      ...
                      GestureDetector(
                        ...
                        child: AnimatedContainer(
                          ...
                          decoration: BoxDecoration(
                            color: isTappedSchedule ? Colors.grey[200] : Colors.grey[300],
                            borderRadius: BorderRadius.circular(20),
                          ),
                          alignment: Alignment.center,
                          width: buttonWidth,
